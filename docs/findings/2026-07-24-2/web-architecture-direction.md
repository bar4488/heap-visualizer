...
Context: [2026-07-24 review](../2026-07-24/README.md), in particular
[F10](../2026-07-24/03-web-structure.md#f10), which is the one finding from
...
intentional stance in [specs/10.3](../../../specs/10-tooling.md) — and web
...
session for layout and view state ([07-analysis §7.7](../../../specs/07-analysis.md)),
...
- `web/fmt.js` in full — `fmtBytes`, `fmtHexSize`, `fmtAllocSize` across all
  ...
  [F17](../2026-07-24/04-minor.md#f17)), `esc`.
...
**This reverses a documented decision.** [specs/10.2](../../../specs/10-tooling.md)
...
- Are multiple documents open at once, and if so of mixed kinds? This is the
  ...
  [08-architecture §8.1](../../../specs/08-architecture.md), session
